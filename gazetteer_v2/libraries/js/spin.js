...
function drawLines(el, opts) {
  ...
  for (var i = 0; i < opts.lines; i++) {
    ...
    backgroundLine.style.transform = "rotate("
      .concat(degrees, "deg) translateX(")
      .concat(opts.radius, "px)");
    ...
    line.style.animation = ""
      .concat(1 / opts.speed, "s linear ")
      .concat(delay, "s infinite ")
      .concat(opts.animation);
